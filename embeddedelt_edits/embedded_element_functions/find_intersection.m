function p = find_intersection(GEOM,FEM,e_connectivity,host1,host2)
...
plane_line1 = GEOM.x0(:,SharedFace(1,2)) - GEOM.x0(:,SharedFace(1,1));
plane_line2 = GEOM.x0(:,SharedFace(1,3)) - GEOM.x0(:,SharedFace(1,2));
plane_normal = cross(plane_line1,plane_line2);
plane_normal = plane_normal./norm(plane_normal);

truss_line = GEOM.x0(:,e_connectivity(2)) - GEOM.x0(:,e_connectivity(1));
...
p0 = GEOM.x0(:,SharedFace(1,4)); Lo = GEOM.x0(:,e_connectivity(1));
