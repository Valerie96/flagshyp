...
% Read Flagshyp file
file=fopen('C:/Users/Valerie/Documents/GitHub/flagshyp/embeddedelt_edits/job_folder/longthing_works/energy.dat','r');
formatSpec = '%e %e %e %e';
sizeA = [4 inf ];
...
%%
% Read Flagshyp file
file=fopen('stiffness-tests\Case1\energy.dat','r');
formatSpec = '%e %e %e %e';
sizeA = [4 inf ];
A = fscanf(file,formatSpec,sizeA);
fclose(file);
