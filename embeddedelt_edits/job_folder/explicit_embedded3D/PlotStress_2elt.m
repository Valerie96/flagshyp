...
basedir='C:/Users/Valerie/Documents/GitHub/flagshyp/embeddedelt_edits/job_folder/explicit_embedded3D/Damped/';
...
hold on; grid on;
fig=gcf; fig.Position=graphsize;
plot([1:4:numsteps], stress_elt2(1:4:numsteps,1));
% xlim([1 740]);
% ylim([-1E7 1E7]);
xlabel("Step Number");
ylabel("Stress (Pa)");
