...
FLAG1h_R5 = ReadFlagshypOutputFile(file5,"StrainRateTesting"', 6502,1);%868,1); 
FLAG1h_R25 = ReadFlagshypOutputFile(file25,"StrainRateTesting"', 1300,1);%175,1);
FLAG1h_R50 = ReadFlagshypOutputFile(file50,"StrainRateTesting"', 652,1);%88,1);
FLAG1h_R200 = ReadFlagshypOutputFile(file200,"StrainRateTesting"', 164,1);%33,1);
...
FLAG1h_25t_R5 = ReadFlagshypOutputFile(file5,"StrainRateTesting"', 6502,1);%868,1); 
FLAG1h_25t_R25 = ReadFlagshypOutputFile(file25,"StrainRateTesting", 1300,1);%175,1);
FLAG1h_25t_R50 = ReadFlagshypOutputFile(file50,"StrainRateTesting"', 652,1);%88,1);
FLAG1h_25t_R200 = ReadFlagshypOutputFile(file200,"StrainRateTesting"', 164,1);%33,1);
...
FLAG1h_25t_R5c = ReadFlagshypOutputFile(file5,"StrainRateTesting"', 6502,1);%867,5); 
FLAG1h_25t_R25c = ReadFlagshypOutputFile(file25,"StrainRateTesting"', 1300,1);%175,1);
FLAG1h_25t_R50c = ReadFlagshypOutputFile(file50,"StrainRateTesting"', 652,1);%88,1);
FLAG1h_25t_R200c = ReadFlagshypOutputFile(file200,"StrainRateTesting"', 164,1);%33,1);
%%
figure();
hold on; grid on;
