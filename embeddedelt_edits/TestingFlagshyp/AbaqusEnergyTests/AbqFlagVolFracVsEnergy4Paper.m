...
FLAG_0 = ReadFlagshypOutputFile(file1,'jf', 613,1);%83,1); 
FLAG_2 = ReadFlagshypOutputFile(file2,'jf', 613,1);%83,1);
FLAG_2c = ReadFlagshypOutputFile(file3,'jf', 613,1);%83,1);

file10="embed_1h_10t";
file10c="embed_1h_10t_correct";
 
FLAG_10 = ReadFlagshypOutputFile(file10,'jf', 613,1);%83,1);
FLAG_10c = ReadFlagshypOutputFile(file10c,'jf', 613,1);%83,1);

file25="embed_1h_25t";
file25c="embed_1h_25t_correct";
 
FLAG_25 = ReadFlagshypOutputFile(file25,'jf', 613,1);%83,1);
FLAG_25c = ReadFlagshypOutputFile(file25c,'jf', 613,1);%83,1);
...
PlotEnergy4([Abq1h_OG.time, Abq1h_OG.KE],[AbqE_1h_25t.time, AbqE_1h_25t.KE], [FLAG_0.Etime, FLAG_0.KE], [FLAG_2.Etime, FLAG_2.KE], name1,name3, "1h 0t Flagshyp","1h 25t Flagshyp",'Kinetic Energy')
PlotEnergy4([Abq1h_OG.time, Abq1h_OG.IE],[AbqE_1h_25t.time, AbqE_1h_25t.IE], [FLAG_0.Etime, FLAG_0.IE], [FLAG_2.Etime, FLAG_2.IE], name1,name3, "1h 0t Flagshyp","1h 25t Flagshyp",'Internal Energy')
PlotEnergy4([Abq1h_OG.time, -Abq1h_OG.WK],[AbqE_1h_25t.time, -AbqE_1h_25t.WK], [FLAG_0.Etime, FLAG_0.WK], [FLAG_2.Etime, FLAG_2.WK],  name1,name3, "1h 0t Flagshyp","1h 25t Flagshyp",'External Energy')
PlotEnergy4([Abq1h_OG.time, Abq1h_OG.ETOTAL],[AbqE_1h_25t.time, AbqE_1h_25t.ETOTAL], [FLAG_0.Etime, FLAG_0.ET], [FLAG_2.Etime, FLAG_2.ET], name1,name3, "1h 0t Flagshyp","1h 25t Flagshyp", 'Total Energy')

figure();
hold on; grid on;
plot(Abq1h_OG.time,Abq1h_OG.Acceleration(:,1),'DisplayName',"Ab OG");
plot(FLAG_0.time,FLAG_0.Acc(:,1,1),'DisplayName',name1,'LineWidth',2);
plot(FLAG_2.time,FLAG_2.Acc(:,1,1),'DisplayName',"1h 2t Flagshyp",'LineWidth',2);
...
figure();
hold on; grid on;
plot(Abq1h_OG.time,Abq1h_OG.Force(:,1),'DisplayName',"Ab OG");
plot(AbqE_1h_25t.time,AbHost_1h_25t.Force(:,1),'DisplayName',"Ab 1h 25t");
plot(FLAG_0.time,FLAG_0.RF(:,1,8),'DisplayName',name1,'LineWidth',2);
plot(FLAG_2.time,FLAG_2.RF(:,1,8),'DisplayName',"1h 2t Flagshyp",'LineWidth',2);
...
figure();
hold on; grid on;
plot(Abq1h_OG.time,Abq1h_OG.Displacement(:,2),'DisplayName',"Ab OG");
plot(FLAG_0.time,FLAG_0.Disp(:,2,1),'DisplayName',name1,'LineWidth',2);
plot(FLAG_2.time,FLAG_2.Disp(:,2,1),'DisplayName',"1h 2t Flagshyp",'LineWidth',2);
