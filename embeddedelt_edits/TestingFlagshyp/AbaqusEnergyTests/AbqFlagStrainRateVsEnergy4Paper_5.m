...
PlotEnergy3([Abq1h_R25.time, Abq1h_R25.KE], [Abq1h_R100.time, Abq1h_R100.KE], [Abq1h_R200.time, Abq1h_R200.KE], name4, "1h Rate100","1h Rate200",'Kinetic Energy')
% PlotEnergy3([Abq1h_R25.time, Abq1h_R25.IE], [Abq1h_R100.time, Abq1h_R100.IE], [Abq1h_R200.time, Abq1h_R200.IE], name4, "1h Rate100","1h Rate200",'Internal Energy')
% PlotEnergy3([Abq1h_R25.time, Abq1h_R25.WK], [Abq1h_R100.time, Abq1h_R100.WK], [Abq1h_R200.time, Abq1h_R200.WK], name4, "1h Rate100","1h Rate200",'External Energy')
% PlotEnergy3([Abq1h_R25.time, Abq1h_R25.ETOTAL], [Abq1h_R100.time, Abq1h_R100.ETOTAL], [Abq1h_R200.time, Abq1h_R200.ETOTAL], name4, "1h Rate100","1h Rate200",'Total Energy')
...
[~, ~, Abq1h_25t_R200] = ReadHostTruss2("StrainRate_5/Ab_1h_25t_Rate200");
graphsize=[100 100 800 400];
name5 = "1h 25t Rate1";
name6 = "1h 25t Rate5";
name7 = "1h 25t Rate10";
...
PlotEnergy3([Abq1h_25t_R25.time, Abq1h_25t_R25.KE], [Abq1h_25t_R100.time, Abq1h_25t_R100.KE], [Abq1h_25t_R200.time, Abq1h_25t_R200.KE], "1h 25t Rate25", "1h 25t Rate100","1h 25t Rate200",'Kinetic Energy')
...
%%
    ...
    AveKE50_0t = Abq1h_R50.KE(end);  AveKE50_25t = Abq1h_25t_R50.KE(end);
    ...
    plot(50, Abq1h_R50.IE(end),'b.','MarkerSize',25, 'DisplayName', '0 Fibers');
    ...
    plot(50, Abq1h_25t_R50.IE(end),'r.','MarkerSize',25, 'DisplayName', '25 Fibers');     
    ...
    plot(50, AveKE50_0t,'b.','MarkerSize',25, 'DisplayName', '0 Fibers');
    ...
    plot(50, AveKE50_25t,'r.','MarkerSize',25, 'DisplayName', '25 Fibers');
    ...
    AveTotEnergy50_0t = Abq1h_R50.KE(end);  AveTotEnergy50_25t = Abq1h_25t_R50.KE(end);
    ...
    AveErr50 = abs(AveTotEnergy50_25t-AveTotEnergy50_0t)/abs(AveTotEnergy50_0t);
    ...
    plot(50, AveErr50*100,'.','MarkerSize',25, 'DisplayName', '50 1/s'); 
    ...
    plot(50, AveTotEnergy50_0t,'b.','MarkerSize',25, 'DisplayName', '0 Fibers'); 
    ...
    plot(50, AveTotEnergy50_25t,'r.','MarkerSize',25, 'DisplayName', '25 Fibers'); 
...
%% Internal Energy Rate
    ...
    AveTotEnergy50_0t = Abq1h_R50.IE(end);  AveTotEnergy50_25t = Abq1h_25t_R50.IE(end);
...
%% Total Energy Rate
    ...
    AveTotEnergy50_0t = mean(Abq1h_R50.ETOTAL);  AveTotEnergy50_25t = mean(Abq1h_25t_R50.ETOTAL);
    ...
    xlabel("Strain Rate (1/s)");
    ylabel("Difference (Error) in Energy (%)");
    title("Difference in Total Energy vs Applied Strain Rate");
    legend('show');
