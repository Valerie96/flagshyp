...
FLAG_o = ReadFlagshypOutputFile("explicit_wShear", 82,1);
...
hold on; grid on;
% fig=gcf; fig.Position=graphsize;
plot(FLAG_o.time,FLAG_o.HostS(:,2),'DisplayName','Host XY Stress elt1','LineWidth',2);
...
hold on; grid on;
% fig=gcf; fig.Position=graphsize;
plot(FLAG_1.time,FLAG_1.HostS(:,2),'DisplayName','Host XY Stress elt1','LineWidth',2);
plot(AbqEHost.time, AbqEHost.Stress(:,2),'DisplayName','Host XY Abaqus','LineWidth',1);
plot(FLAG_1.time,FLAG_1.TrussS(:,1),'DisplayName','Embedded Stress','LineWidth',2);
