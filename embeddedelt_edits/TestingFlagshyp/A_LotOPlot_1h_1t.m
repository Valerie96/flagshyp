...
hold on; grid on;
% fig=gcf; fig.Position=graphsize;
plot(FLAG_1.time,FLAG_1.HostLE(:,4,1),'DisplayName',name1,'LineWidth',2);
plot(FLAG_2.time,FLAG_2.HostLE(:,4,1),'DisplayName',name2,'LineWidth',2);
plot(FLAG_3.time,FLAG_3.HostLE(:,4,1),'DisplayName',name3,'LineWidth',1);
title("YY Log Strain: Host");
xlabel("Time (s)");
ylabel("Strain ");
legend('show');
...
plot(AbqEHost.time,AbqEHost.Displacement(:,1),'ro' ,'DisplayName',name2a);
...
hold on; grid on;
% fig=gcf; fig.Position=graphsize;
plot(AbqOneHost.time,AbqOneHost.Acceleration(:,1),'bo','DisplayName',name1a);
plot(AbqEHost.time,AbqEHost.Acceleration(:,1),'ro' ,'DisplayName',name2a);
plot(FLAG_1.time,FLAG_1.Acc(:,1,1),'b','DisplayName',name1,'LineWidth',3);
plot(FLAG_2.time,FLAG_2.Acc(:,1,1),'r','DisplayName',name2,'LineWidth',3);
plot(FLAG_3.time,FLAG_3.Acc(:,1,1),'g','DisplayName',name3,'LineWidth',2);
title("X Acceleration");
xlabel("Time (s)");
ylabel("Acceleration (m/s^2) ");
legend('show');
